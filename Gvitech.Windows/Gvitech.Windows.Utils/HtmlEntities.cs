...
namespace Mmc.Windows.Utils
{
	internal static class HtmlEntities
	{
		...
		private static readonly Dictionary<string, char> LookupTable = HtmlEntities.GenerateLookupTable();

		private static Dictionary<string, char> GenerateLookupTable()
		{
			Dictionary<string, char> dictionary = new Dictionary<string, char>(StringComparer.Ordinal);
			string[] entitiesList = HtmlEntities.EntitiesList;
		...
		{
			char result;
			HtmlEntities.LookupTable.TryGetValue(entity, out result);
			return result;
		}
	}
}
