...
namespace Mmc.Mspace.PoiManagerModule
{
    ...
    /// </summary>
    public partial class MakerPolygonView 
    {
        DispatcherTimer timer;
        public MakerPolygonView()
        {
            InitializeComponent();
            this.Unloaded += MakerPolygonView_Unloaded;
        ...
        private void MakerPolygonView_Unloaded(object sender, RoutedEventArgs e)
        {
            if (timer != null)
                timer.Stop();
        }
        ...
        private void SLColorPicker_SelectedColorChanged(object sender, RoutedPropertyChangedEventArgs<System.Windows.Media.Color?> e)
        {
            var vm = this.DataContext as PoiBaseViewModel;
            vm.SLStyleColor = SLColorPicker.SelectedColor;
        }
    }
}